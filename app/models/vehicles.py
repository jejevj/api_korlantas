...
class Vehicle(db.Model):
    ...
    status = db.Column(db.BigInteger,  nullable=False)  # status, foreign key from statuses
    user_id = db.Column(db.BigInteger,nullable=False)  # user_id, foreign key from users
    cfd_id = db.Column(db.BigInteger,  nullable=False)  # cfd_id, foreign key from cfd
    genpdf_id = db.Column(db.BigInteger, nullable=False)  # genpdf_id, foreign key from genpdf
